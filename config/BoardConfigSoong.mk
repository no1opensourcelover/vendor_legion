...
SOONG_CONFIG_legionGlobalVars += force_build_fingerprint
endif
...
SOONG_CONFIG_legionQcomVars_legacy_hw_disk_encryption := $(TARGET_LEGACY_HW_DISK_ENCRYPTION)
...
SOONG_CONFIG_legionQcomVars_supports_audio_accessory := $(TARGET_QTI_USB_SUPPORTS_AUDIO_ACCESSORY)
SOONG_CONFIG_legionQcomVars_supports_debug_accessory := $(TARGET_QTI_USB_SUPPORTS_DEBUG_ACCESSORY)
...
ifneq ($(TARGET_FORCE_BUILD_FINGERPRINT),)
SOONG_CONFIG_legionGlobalVars_force_build_fingerprint := $(TARGET_FORCE_BUILD_FINGERPRINT)
endif
